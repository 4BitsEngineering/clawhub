...
// Equipo AI-Office por defecto (mismo set que valida el configurator; el shape
// de agents[*] es 1:1 con lo que espera configure-overlay.js). runtime id =
// office-<slug>-v1 — debe cuadrar con los agentId de dispatch.config.json.
const DEFAULT_TEAM = [
  ...
  { agent: "personal-assistant", slug: "pa", displayName: "Asistente Personal", shortName: "Asistente Personal", icon: "🪄", color: "#3B6FE0", workingVerb: "investigando", voice: { kind: "neutral" },
  ...
  { agent: "founder", slug: "founder", displayName: "Founder", shortName: "Founder", icon: "🧭", color: "#7A6A53", workingVerb: "afinando tu contexto", voice: { kind: "neutral" },
  ...
  { agent: "automation-engineer", slug: "engineer", displayName: "Automatización", shortName: "Automatización", icon: "🤖", color: "#65A30D", workingVerb: "conectando piezas", voice: { kind: "male" },
  ...
  { agent: "executive", slug: "executive", displayName: "Agenda y Correo", shortName: "Agenda y Correo", icon: "📋", color: "#4F6D9E", workingVerb: "ordenando tu día", voice: { kind: "female" },
  ...
  { agent: "webops", slug: "webops", displayName: "WebOps", shortName: "WebOps", icon: "🌐", color: "#3A6E8F", workingVerb: "operando en la web", voice: { kind: "neutral" },
